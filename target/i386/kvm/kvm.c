...
/*
 * Currently the only supported use of KVM_HC_MAP_GPA_RANGE is to handle
 * servicing of guest-initiated memory attribute update requests so that
 ...
 *
 * For the guest_memfd use-case, these exits will generally be sythesized
 ...
 * because private/shared page reported is already provided through other
